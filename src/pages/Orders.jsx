            ...
            <div key={index} className='py-4 border-t border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
              <div className="flex items-start gap-6 text-sm">
                ...
                <div className="">
                  ...
                  <div className="flex items-center gap-3 mt-2 text-base text-gray700 dark:text-gray-300">
                    <p className="text-lg">{currency}{item.price}</p>
                    <p className="">Quantity: 1</p>
                    <p className="">Size: M</p>
                  </div>
                  <p className="mt-2">Date: <span className='text-gray-400 dark:text-gray-600'>25, Mar 2025</span></p>
                </div>
              </div>
